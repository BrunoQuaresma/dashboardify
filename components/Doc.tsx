...
export const Doc = (props: BoxProps) => {
  ...
  "sections": [
    ...
    },
    {
      ...
      <Text>
        As you can see, the dashboard is made up of sections that can have stats
        or a table. To see the dashboard generated by this example, you can go
        to the{" "}
